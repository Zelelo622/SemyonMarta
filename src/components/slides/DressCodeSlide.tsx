...
function Kokoshnik({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g stroke="#B81E26" strokeWidth="1.2" fill="none">
        {/* лицо */}
        <circle cx="60" cy="80" r="22" fill="#F5EBDC" />
        {/* косы */}
        ...
        {/* подвески */}
        <g stroke="#F5EBDC" strokeWidth="0.8" fill="none">
        ...
        {/* черты лица */}
        <g stroke="#B81E26" fill="none" strokeLinecap="round">
          <circle cx="53" cy="78" r="0.8" fill="#B81E26" />
          <circle cx="67" cy="78" r="0.8" fill="#B81E26" />
...
function Lapti({ className = '' }: { className?: string }) {
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <g stroke="#B81E26" strokeWidth="1.1" fill="none">
        {/* левый лапоть */}
        <g transform="translate(8 30) rotate(-12)">
          ...
          />
          {/* плетение */}
          <g stroke="#B81E26" strokeWidth="0.8">
            <path d="M4 18 L52 18" />
            <path d="M4 26 L52 26" />
            <path d="M4 34 L52 34" />
          ...
          {/* носок */}
          <path d="M48 8 L56 4 L56 14" fill="#B81E26" />
          {/* шнурки */}
          <path
  ...
  return (
    <section data-slide-index="4" className="slide-base above-paper bg-cream">
      ...
      >
        ...
        <p className="text-center font-marck text-ink-muted text-xl mt-10">
